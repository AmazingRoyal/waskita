...
export default function ListFormAmbulanceScreen({navigation}) {
    return(
        <SafeAreaView style={styles.base}>
            ...
            <TouchableOpacity
                ...
                // onPress={() => {navigation.navigate('Form STT Rescue')}}
            >
                <Text style={styles.button_text}>Daftar Obat</Text>
            </TouchableOpacity>
            <TouchableOpacity
                style={styles.button}
                // onPress={() => {navigation.navigate('Form STT Rescue')}}
            >
                <Text style={styles.button_text}>Laporan Data Korban</Text>
            </TouchableOpacity>
